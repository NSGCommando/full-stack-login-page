...
## Initial Setup ##
- There is a file called .env.example with example of admin details
- Rename it to .env and change the admin username and password to whatever you want, then run
